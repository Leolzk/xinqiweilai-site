    ...
    <main className="site-shell">
      <section className="hero" id="top">
        ...
        <div className="hero-content layout-boundary">
          ...
          <aside className="hero-readout" aria-label="类器官平台状态"><div className="readout-top"><span className="status-dot" /> LIVE SYSTEM MAP</div><div className="readout-number">3D</div><p>将模型、微环境与读数路径组织为一套可持续演进的生命科学系统。</p><div className="readout-rule"><span />FUTURE MIND ECOSYSTEM</div></aside>
        </div>
